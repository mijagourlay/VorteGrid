...
extern const float  sNegligibleVorticityThreshold ;
...
/*! \brief Specify vorticity in a specific shape of a vortex ring.
...
/*! \brief Specify a ball of fluid with a given density deviation
*/
class DensityBall : public IVorticityDistribution
{
    public:
        /*! \brief Initialize ball of fluid with the given density deviation-about-ambient
        */
...
/*! \brief Specify a box of fluid with a given density deviation
*/
class DensityBox : public IVorticityDistribution
{
    public:
        /*! \brief Initialize box of fluid with a given density deviation-about-ambient
        */
...
class VortexSheet : public IVorticityDistribution
{
    public:
        ...
        */
        ...
        virtual void AssignVorton( Vec3 & vorticity , float & density , const Vec3 & position , const Vec3 & vCenter ) const
        {
            (void) vCenter ; // Avoid "unreferenced formal parameter" warning.
...
class VortexNoise : public IVorticityDistribution
{
    public:
        ...
        */
        ...
        virtual void AssignVorton( Vec3 & vorticity , float & density , const Vec3 & position , const Vec3 & vCenter ) const
        {
            (void) position ; // Avoid "unreferenced formal parameter" warning.
            (void) vCenter ; // Avoid "unreferenced formal parameter" warning.
