        ...
        {   // Treat particles as vortons.
            ...
            {   // For each vorton in the simulation...
                ...
                {   // Vorton is interacting with body.
                    ...
                    const Vec3  vSurfNormal         = vSphereToVorton.Direction() ;
                    const Vec3  vVelDir             = velFlowRelBodyAtColPt.Direction() ;
                    ...
                    const float fMassVorton             = rVorton.GetMass( ambientFluidDensity ) ;
                    const float fRadiusVorton           = rVorton.GetRadius() ;
                    const float fMomentOfInertiaVorton  = 0.4f * fMassVorton * fRadiusVorton * fRadiusVorton ;
