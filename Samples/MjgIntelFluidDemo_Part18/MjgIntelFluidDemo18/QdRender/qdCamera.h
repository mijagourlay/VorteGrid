...
class QdCamera
{
    public:
        ...
        const float &   GetFieldOfViewVertical() const      { return mFieldOfViewVertical ; }
    ...
    private:
        ...
        float   mFieldOfViewVertical    ;   ///< Vertical field of view in degrees.
        float   mAspectRatio            ;   ///< Viewport aspect ratio
        float   mNearClipDist           ;
        float   mFarClipDist            ;
