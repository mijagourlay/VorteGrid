    ...
    */
    class RigidBody
    {
        public:
            ...
            void SetAngularMomentum( const Vec3 & angularMomentum ) { mAngularMomentum = angularMomentum ; }
...
extern void RigidBody_UpdateSystem( const std::Vector< RigidBody * > & rigidBodies , float timeStep , unsigned uFrame ) ;
extern Vec3 RigidBody_ComputeAngularMomentum( const std::Vector< RigidBody * > & rigidBodies ) ;
