...
#include "Core/Space/uniformGrid.h"
    ...
    {   // For each z-coordinate...
        ...
        {   // For each y-coordinate...
            ...
            {   // For each x-coordinate...
                ...
                Vec3 vorticity ;
                float densityDeviation ;
                vorticityDistribution.AssignVorton( vorticity , densityDeviation , positionLocal , vCenter ) ;
                ...
                {   // Vorticity is significantly non-zero.
                    vorton.mDensityDeviation = densityDeviation ;
                #if ENABLE_FIRE
