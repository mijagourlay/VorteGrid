...
// NOTE: The "diffusing" version of this downsampler might be more appropriate when assigning values
// for the maximal gridpoints.
// Ultimately, the choice of which technique to use depends on which provides better results, including performance.
// Remember that the results on the low-res grid are effectively only starters for the results obtained on the high-res
// grid, so to that extent even an approximate answer provides value.  So it's probably better to favor speed over accuracy here.
...
class UniformGridGeometry
{
    public:
        ...
        */
        ...
        /*! \brief Return whether the given query point lies inside the boundaries of this grid.
        */
        ...
        /*! \brief Return whether the shape of this object matches that of the given.
        ...
        */
        ...
        /*! \brief Whether this geometry has zero extent
        */
        ...
        */
        ...
        /*! \brief Return volume (in world units) of a grid cell.
        */
...
template <class ItemT> class UniformGrid : public UniformGridGeometry
{
    public:
        ...
        */
        ...
        /*! \brief Scale each value in this grid by the given scalar
        ...
        */
        ...
        /*! \brief Return whether this container contains any items
        */
        ...
        */
        ...
        /*! \brief Interpolate values from grid to get value at given position
            ...
            \note   This version assumes the floating-point-control-word is set
                    ...
                    Setx87ControlWord to return the FPCW back to "rounding" (the
        ...
        */
        ...
        /*! \brief Accumulate given value into grid at given position
        ...
        */
        ...
        /*! \brief Restrict values from a high-resolution grid into a low-resolution grid
        ...
        */
        ...
        /*! \brief Interpolate value from the given low-resolution grid into this high-resolution grid
        ...
        */
        ...
        /*! \brief Compute zeroth moment of contents of this container
        */
