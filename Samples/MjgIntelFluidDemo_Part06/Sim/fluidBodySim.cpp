    ...
    {   // For each body in the simulation...
        ...
        {   // For each vorton in the simulation...
            ...
            {   // Vorton is interacting with body.
                ...
                const Vec3  vAngVelDiff         = 0.5f * rVorton.mVorticity - rSphere.mAngVelocity ;    // (negative of) change in angular velocity applied to vorton
...

                {
                    ...
                    const float sMultiplier = 2.0f * rSphere.mRadius / rVorton.mRadius ;
                    rVorton.mVorticity += ( sMultiplier * 2.0f * rSphere.mAngVelocity - vVorticityOld ) /* * mVortonSim.GetViscosity() */ ;
                ...
                const Vec3  vAngVelDiff     = 0.5f * ( vVorticityOld - rVorton.mVorticity ) ;   // (negative of) change in angular velocity applied to vorton
#endif
                ...
                // the body "catches up" with the flow moving past it, at which point the body stops
