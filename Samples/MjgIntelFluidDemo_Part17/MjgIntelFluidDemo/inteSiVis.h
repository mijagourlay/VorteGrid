...
class InteSiVis
{
    public:
        ...
        */
        ...
        void InitializeDisplayandInputDevices( int * pArgc , char ** argv ) ;
    ...
    private:
        ...
        */
        ...
        void            RenderVortons() ;
        void            RenderTracers() ;
        void            RenderNonFluidParticles() ;
        void            RenderDiagnosticPathlines( VECTOR< Particle > & Particles ) ;
        void            RenderDiagnosticGrid() ;
        ...
        ParticleSystemManager                   mPclSysMgr                     ;   ///< Addresses of non-fluid particle systems

        FluidVortonPclGrpInfo       mVortonPclGrpInfo           ;
        FluidTracerPclGrpInfo       mTracerPclGrpInfo           ;

        QdCamera                    mCamera                     ;   ///< Camera for rendering
        VECTOR< QdLight >           mLights                     ;   ///< Lights
        VECTOR< QdModel >           mModels                     ;   ///< Models to render.
        GLuint                      mBallDisplayList            ;   ///< Identifier for ball geometry cached in OpenGL server.
        QdMaterial                  mPhysObjMaterial            ;   ///< Material used to render physical objects
        QdMaterial                  mContainerMaterial          ;   ///< Material used to render container physical objects
        ...
        ParticleMaterial            mDiagnosticVortonMaterial   ;   ///< Material used to render vortons for diagnostics
        ParticleMaterial            mSimpleVortonMaterial       ;   ///< Material used to render vortons
        ParticleMaterial            mDiagnosticTracerMaterial   ;   ///< Material used to render tracers for diagnostics
        ParticleMaterial            mDyeMaterial                ;   ///< Material used to render tracers as dye that depends on density
        ...
        ParticleMaterial            mFuelMaterial               ;   ///< Material used to render tracers as fuel
        ParticleRenderer            mDiagnosticVortonRenderer   ;   ///< Renderer for vortons for diagnostics
        ParticleRenderer            mSimpleVortonRenderer       ;   ///< Renderer for vortons
        ParticleRenderer            mDiagnosticTracerRenderer   ;   ///< Renderer for tracers for diagnostics
        ParticleRenderer            mDyeRenderer                ;   ///< Renderer for tracers whose texture depends on density.
        ParticleRenderer            mSmokeRenderer              ;   ///< Renderer for smoke tracers
        ParticleRenderer            mFlameRenderer              ;   ///< Renderer for flame tracers
        ParticleRenderer            mFuelRenderer               ;   ///< Renderer for fuel tracers
