...
class VortonSim
{
    ...
    private:
        ...
        void        PopulateSignedDistanceGridFromParticleDensity( UniformGrid< float > & signedDistanceGrid , const UniformGrid< float > & densityGrid , const unsigned uFrame) ;
        ...
        void        UpdateVpm( float timeStep , unsigned uFrame ) ;
#if USE_SMOOTHED_PARTICLE_HYDRODYNAMICS
        void        UpdateSph( float timeStep , unsigned uFrame ) ;
#endif
