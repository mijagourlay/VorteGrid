                                      ...
                                      , const UniformGrid< VECTOR< unsigned > > & pclIndicesGrid )
{
    ...
    QUERY_PERFORMANCE_EXIT( SPH_ComputeSphNumberDensityAtParticles_Grid ) ;
#endif
}
                                                ...
                                                )
{
    ...
    QUERY_PERFORMANCE_EXIT( SPH_ComputeSphPressureGradientAcceleration_Grid ) ;
#endif
}
...
static void DiffuseAndDissipateVelocitySph_Grid( VECTOR< Vorton > & particles , const float timeStep , const UniformGrid< VECTOR< unsigned > > & pclIndicesGrid )
{
    ...
    QUERY_PERFORMANCE_EXIT( SPH_DiffuseAndDissipateVelocitySph_Grid ) ;
#endif
}
...
*/
void VortonSim::UpdateSph( float timeStep , unsigned uFrame )
{
    QUERY_PERFORMANCE_ENTER ;
    ...
    QUERY_PERFORMANCE_EXIT( VortonSim_UpdateSph ) ;
}
...
float VortonSim::ReduceDivergence( VECTOR< Vorton > * vortons , const UniformGrid< VECTOR< unsigned > > & pclIndicesGrid )
{
    ...
    QUERY_PERFORMANCE_EXIT( VortonSim_ReduceDivergence ) ;
