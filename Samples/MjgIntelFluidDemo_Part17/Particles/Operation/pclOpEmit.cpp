...
void PopulateDensityDeviationGridFromParticles( const VECTOR< Particle > & particles , const float ambientFluidDensity , UniformGrid< float > & densityDeviationGrid )
{
    ...
    QUERY_PERFORMANCE_EXIT( PopulateDensityDeviationGridFromParticles ) ;
}
...
void PclOpEmit::Emit( VECTOR< Particle > & particles , const UniformGridGeometry & uniformGrid , unsigned multiplier , const VECTOR< Particle > * vortons )
{
        ...
        {   // Want to place tracer particles here.
            ...
            {   // For each subdomain within each grid cell...
                ...
                {   // Vortons were passed in so assign density based on
                    ...
                    pcl.mDensity = ( densityDeviationHere + 1.0f ) * ambientFluidDensity ;
    ...
    QUERY_PERFORMANCE_EXIT( PclOpEmit_Emit ) ;
}
...
void PclOpEmit::Operate(  VECTOR< Particle > & particles , float timeStep , unsigned uFrame )
{
    ...
    QUERY_PERFORMANCE_EXIT( PclOpEmit_Operate ) ;
}
...
#include "pclOpEmit.h" // TODO: Change to pclOpSeedSurfaceTracers.h after splitting file.
...
static tbb::atomic< bool > sDebugMutex                 ;   /// Mutex lock, used to synchronize debug output.
...
#define DIAGNOSE_IMMEDIATE_SDF 0
    ...
    QUERY_PERFORMANCE_EXIT( ComputeImmediateSDFFromDensity_Nearest ) ;
}
...
#define DIAGNOSE_FULL_SDF 1
    ...
    QUERY_PERFORMANCE_EXIT( ComputeRemainingSDFFromImmediateSDF_Nearest ) ;
}
...
void ComputeSDF_Sphere( UniformGrid< float > & signedDistanceGrid )
{
    ...
    QUERY_PERFORMANCE_EXIT( ComputeSDF_Sphere ) ;
}
                                                          ...
                                                          , const unsigned uFrame )
{
    ...
    QUERY_PERFORMANCE_EXIT( PopulateSignedDistanceGridFromSurfaceTracerParticles ) ;
}
...
//}
    ...
    QUERY_PERFORMANCE_EXIT( PclOpSeedSurfaceTracers_Emit ) ;
}
                                        ...
                                        , const float ambientDensity )
{
    ...
    static const maxNumPclsPerCell = 2 ;
...
//}
    ...
    QUERY_PERFORMANCE_EXIT( PclOpSeedSurfaceTracers_Replace_perCellPclReplacement ) ;
    ...
    QUERY_PERFORMANCE_EXIT( PclOpSeedSurfaceTracers_Replace ) ;
}
...
void PclOpSeedSurfaceTracers::Operate(  VECTOR< Particle > & particles , float timeStep , unsigned uFrame )
{
    ...
    QUERY_PERFORMANCE_EXIT( PclOpSeedSurfaceTracers_Operate ) ;
}
