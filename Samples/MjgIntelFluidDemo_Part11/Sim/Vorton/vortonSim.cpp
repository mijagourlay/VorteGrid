...
#define USE_ARRHENIUS 1
    ...
    /** Function object to compute velocity grid using Threading Building Blocks.
    */
...
/** Compute the total circulation, linear impulse and angular impulse of all vortons in this simulation.
    ...
    \param linearImpulse - (out) Volume integral of velocity.
        See Saffman section 3.2, "Hydrodynamic impulse", equation 14.

    \param vAngular Impulse - (out) Volume integral of vorticity weighted by the second moment of position.
...
*/
void VortonSim::GatherVorticityStats( float & min , float & max , float & mean , float & stddev ) const
{
    min = 1.0e8f ;
    max = - min ;
    float           sum         = 0.0f ;
...
/** Populate a UniformGrid with density values from vortons.
    ...
    \param ambientDensity   Density in the absence of particles.
...
//#error WORK IN PROGRESS.
    static int numRegrid = 1 ;
    for( int iRegrid = 0 ; iRegrid < numRegrid ; ++ iRegrid )
    {
