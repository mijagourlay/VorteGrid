...
class UniformGridGeometry
{
    public:
        ...
        */
        ...
        /** Compute indices into contents array of a point at a given position.  Assumes floating point control word is set to use truncation instead of nearest, for rounding.
            \see IndicesOfPosition, StoreFloatAsInt.
        */
