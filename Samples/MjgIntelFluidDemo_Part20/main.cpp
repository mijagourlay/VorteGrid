...
static void SetUpLogFiles( char mainPerfBlockName[ 256 ] , char ** argv )
{
#if PROFILE
    ...
    static PerfLoggerFileStream perfLogger( perfFileName ) ;
    PerfBlock::SetLogFunc( PerfLoggerFileStream::LogFunc ) ;
#else
    UNUSED_PARAM( argv )
#endif

    sprintf( mainPerfBlockName , "VorteGrid__main__run_%i" , sStartTime ) ;
}
...
int main( int argc , char ** argv )
{
    ...
    SetUpLogFiles( mainPerfBlockName , argv ) ;
