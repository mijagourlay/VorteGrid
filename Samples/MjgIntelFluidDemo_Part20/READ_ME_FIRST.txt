...
Place glut-3.7.6 in VorteGrid/External/glut-3.7.6.

Set up Visual Studio paths for GLUT:
Tools --> Options --> Projects --> VC++ Directories
--> Show directories for: Include files
--> Add --> (browse to glut-3.7.6)
--> Show dir...: Library files:
--> Add --> (browse to glut-3.7.6\Release)
