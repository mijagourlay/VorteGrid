...
/** Set size for a multi-page image.
...
*/
void Image::SetSize( unsigned width , unsigned height , unsigned numChannels , unsigned numPages )
{
    mNumChannels = numChannels       ;
    mWidth       = width             ;
    mHeight      = height            ;
...
void Image::AllocateImageData()
{
    ...
    ASSERT( NULLPTR == mImgData ) ; // Otherwise memory leaks.
