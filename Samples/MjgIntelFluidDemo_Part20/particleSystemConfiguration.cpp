...
*/
static ParticleGroup * CreateVortonParticleGroup( FluidVortonPclGrpInfo & vortonPclGrpInfo , const float viscosity , const float ambientFluidDensity , const float fluidSpecificHeatCapacity , const Vec3 & gravityAcceleration , VECTOR< Impulsion::PhysicalObject * > & physicalObjects )
{
    PERF_BLOCK( CreateVortonParticleGroup ) ;
...
static ParticleGroup * CreateTracerParticleGroup( FluidTracerPclGrpInfo & tracerPclGrpInfo , FluidVortonPclGrpInfo & vortonPclGrpInfo , const float ambientFluidDensity )
{
    PERF_BLOCK( CreateTracerParticleGroup ) ;
...
ParticleSystem * CreateFluidParticleSystem( FluidVortonPclGrpInfo & vortonPclGrpInfo , FluidTracerPclGrpInfo & tracerPclGrpInfo , const float viscosity , const float ambientFluidDensity , const float fluidSpecificHeatCapacity , VECTOR< Impulsion::PhysicalObject * > & physicalObjects )
{
    PERF_BLOCK( CreateFluidParticleSystem ) ;

    ParticleSystem * fluidParticleSystem = new ParticleSystem() ;

    // Set up particle group for vortons.
    CreateVortonParticleGroup( vortonPclGrpInfo , viscosity , ambientFluidDensity , fluidSpecificHeatCapacity , sGravityAcceleration , physicalObjects ) ;

    // Set up particle group for passive tracers.
    CreateTracerParticleGroup( tracerPclGrpInfo , vortonPclGrpInfo , ambientFluidDensity ) ;
