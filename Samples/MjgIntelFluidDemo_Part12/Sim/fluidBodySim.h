...
{
    public:
        static void SolveBoundaryConditions( Vector< Particle > & particles , const UniformGrid< Vec3 > & velGrid , float ambientFluidDensity , float fluidSpecificHeatCapacity , const Vector< RigidBody * > & rigidBodies , bool bRespectAngVel ) ;
    ...
    private:
        ...
        static Vec3 CollideTracersReduce( Vector< Particle > & particles , float ambientFluidDensity , const RbSphere & rSphere , size_t iPclStart , size_t iPclEnd , size_t grainSize ) ;
