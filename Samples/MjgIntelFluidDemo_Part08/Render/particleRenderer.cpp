    ...
    if( gVboSupported )
    {
        ...
        {   // Vertex buffer grew so we need more texture coordinates.
            ...
            {   // For each particle in this slice...
                ...
                // Assign which texture page to use based on sign of size, which in turn depends on sign of initial density variation.
                const float v0 = rSize >= 0.0f ? v0Heavy : v0Light ;
                const float v1 = rSize >= 0.0f ? v1Heavy : v1Light ;
