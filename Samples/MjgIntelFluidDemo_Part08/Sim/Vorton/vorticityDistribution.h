...
/*! \brief Specify a ball of heavy fluid


*/
class HeavyBall : public IVorticityDistribution
{
    public:
        /*! \brief Initialize ball of heavy fluid
        */
        HeavyBall( float fRadius , float fDensity )
            : mRadius( fRadius )
            , mDensity( fDensity )
        {
        }
