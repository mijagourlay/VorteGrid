...
// MJG added _MSC_VER and added sal.h to this DXSDK dir to build XAudio2 with VisualStudio2003
#if defined(_MSC_EXTENSIONS) && !defined( MIDL_PASS ) && !defined(__midl) && !defined(RC_INVOKED) && ( _MSC_VER > 1310 )
